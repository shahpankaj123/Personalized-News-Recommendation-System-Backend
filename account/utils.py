...
def send_activation_email(recipient_email, activation_url):
    ...
    html_content = render_to_string('accounts/activate_email.html', {'activation_url': activation_url,'topic':'Activation Mail','desc':'Youre receiving this email because you need to finish activation process.'})
